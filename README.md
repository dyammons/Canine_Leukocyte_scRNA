...
If you have any questions or concerns, please submit an issue, contact the corresponding author(s), and/or contact Dylan Ammons at dyammons95@gmail.com.
...
Required input: a list of gene symbols that you wish to query.
...
```r
#load in the refernce data from supplemental data
...
#plot the results -- uses a custom function, but can also be visulized with base FeaturePlot() or DotPlot() functions
